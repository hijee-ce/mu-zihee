...
public class MusicalDto {
    ...
    private MultipartFile musicalDiscountImg;
    private String musicalDetail;
    private MultipartFile musicalDetailImg;
    private String musicalCategory;
    private String categoryName;

    public MusicalDto(){ }

    public MusicalDto(Long musicalCode, String musicalName, String musicalPoster,
                      ...
                      MultipartFile musicalPosterImg, String categoryName,
                      MultipartFile musicalDiscountImg, MultipartFile musicalDetailImg)
    {
        ...
        this.musicalDiscountImg = musicalDiscountImg;
        this.musicalDetail = musicalDetail;
        this.musicalDetailImg = musicalDetailImg;
    ...
    public MultipartFile getMusicalDiscountImg() { return musicalDiscountImg; }

    public void setMusicalDiscountImg(MultipartFile musicalDiscountImg) { this.musicalDiscountImg = musicalDiscountImg; }

    public MultipartFile getMusicalDetailImg() { return musicalDetailImg; }

    public void setMusicalDetailImg(MultipartFile musicalDetailImg) { this.musicalDetailImg = musicalDetailImg; }
    ...
    public String toString() {
        return "MusicalDto{" +
                ...
                ", musicalDiscountImg='" + musicalDiscountImg + '\'' +
                ", musicalDetail=" + musicalDetail +
                ", musicalDetailImg='" + musicalDetailImg + '\'' +
